...
#define CHAIN std::map<D,C>
#define CCHAIN Chain<C,Cell<C,BT>*>
#define CSTRUCT std::map<Cell<C,BT>*,C>
...
public:
	...
	friend std::ostream& operator << (std::ostream& out, const Cell<C,BT>& toPrint)
	{
		toPrint.print(out);
		return out;
	}
	...
	virtual void showGens(std::ostream&, bool, const std::string) const;
	...
	/// MTX
	bool isKQPair(const Cell<C,BT>* k, const Cell<C,BT>* q, bool checkbt);
	bool isQKPair(const Cell<C,BT>* q, const Cell<C,BT>* k, bool checkbt);
	bool isFreeFace(const Cell<C,BT>* face, Cell<C,BT>*& coface, bool checkbt);
	bool isFreeCoface(const Cell<C,BT>* coface, Cell<C,BT>*& face, bool checkbt);
};
...
public:
	...
	friend std::ostream& operator <<(std::ostream& out, const Chain<C,D>& toPrint)
	{
