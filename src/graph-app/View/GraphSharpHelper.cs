...
namespace CHoleR.Helper
{
    ...
    public class TaggedEdge : WeightedEdge<Object>, INotifyPropertyChanged
    {
        private string tag;
        ...
        public TaggedEdge(Object source, Object target, double weight, Color color, String tag = null, Color? lastColor = null)
            : base(source, target)
        {
            this.Source = source;
            this.Target = target;
            ...
            this.Tag = tag;
            this.LastColor = (lastColor != null) ? (Color) lastColor : defaultColor;
        }
    ...
    public class TaggedVertex : Vertex, INotifyPropertyChanged
    {
        private string tag;
        private Object name;
        private Color color;
        ...
        public TaggedVertex(Object name, Color color, String tag = null, Color? lastColor = null)
            : base(name, color)
        {
            this.Name = name;
            this.Color = (color != null) ? (Color) color : defaultColor;
