...
{
	public class BidirectionalWeightedGraph<TVertex, TEdge> : BidirectionalGraph<TVertex, TEdge>, IBidirectionalWeightedGraph<TVertex,TEdge>
		where TEdge : WeightedEdge<TVertex>
	{
		...
		public BidirectionalWeightedGraph( bool allowParallelEdges )
			: base( allowParallelEdges )
		{
			Init();
		}

		public BidirectionalWeightedGraph( bool allowParallelEdges, int vertexCapacity)
