...
{
	/// <summary>
	/// This graph: Has weighted edges, which can be hidden along with vertices.
	/// </summary>
	/// <typeparam name="TVertex"></typeparam>
	/// <typeparam name="TEdge"></typeparam>
	public interface IBidirectionalWeightedGraph<TVertex, TEdge> : IBidirectionalGraph<TVertex, TEdge>
